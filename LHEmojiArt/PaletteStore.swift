...
//            for palletAsArray in palettesAsPropertyList {
//                if palletAsArray.count == 3, let id = Int(palletAsArray[2]), !palettes.contains(where: {$0.id == id}) {
//                    let palette = Palette(name: palletAsArray[0], emojis: palletAsArray[1], id: id)
